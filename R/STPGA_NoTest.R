STPGA_NoTest<-function(P, ntoselect, npop, nelite, mutprob, mutintensity=1,
  ...
  for (reppool in 1:preppoolrep){
    ...
    listofgoodsolstemp<-parallel::mclapply(1:preppoolsize,function(x){return(GenAlgForSubsetSelectionNoTest(P=P,ntoselect=ntoselect,npop=npop, nelite=nelite, mutprob=mutprob, mutintensity=mutintensity,niterations=min(c(10,ceiling(niterations/100))), lambda=lambda,
  ...
  ListTrain1<-GenAlgForSubsetSelectionNoTest(P=P,ntoselect=ntoselect, 
